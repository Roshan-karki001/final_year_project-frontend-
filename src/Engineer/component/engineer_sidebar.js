...
import { Home, Briefcase, MessageSquare, FileText, Star, User, HelpCircle, LogOut, Bell, X ,Search} from "lucide-react";
...
const mainMenuItems = [
  ...
  { title: "Find people", path: "/engineer/search-engineers", icon: <Search size={20} /> }, // Updated path to match client sidebar
];
      ...
      <div className="mt-auto">
        <ul>
          ...
          <li className="mb-2">
            ...
            <Link to="/engineer/support" className="flex items-center gap-2 p-2 rounded transition-colors hover:bg-gray-300">
